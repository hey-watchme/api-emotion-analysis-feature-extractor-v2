...
def main():
    parser = argparse.ArgumentParser(description='Kushinada音声感情分析')
    ...
    result = recognizer.predict_emotion(args.audio_file)
    ...
    output_file = f"emotion_analysis_result_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
